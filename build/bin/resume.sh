...
echo "\nStart resuming archive Data in 5 seconds\n\n"
sleep 5


#./geth  --datadir ${DataDir} --syncmode=full --gcmode=archive \
./geth --datadir ${DataDir} --syncmode=full \
		--http --http.port "8082" --http.corsdomain="*" --http.api="admin,eth,debug,miner,net,txpool,personal,web3" \
       --cache 100000 --cache.database 80 --cache.trie 50 \
       --snapshot=false --port 30304
