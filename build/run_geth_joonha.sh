...
./bin/geth --syncmode full --gcmode archive --datadir $path --http --http.port 8550 --http.api admin,debug,web3,eth,txpool,personal,ethash,miner,net --cache 60000 --networkid 1024 --port 30303 --allow-insecure-unlock --maxpeers 0 --verbosity 3 --discovery.dns "" --nodiscover console # --snapshot=false --activeSnapshot=false --inactiveStorageSnapshot=false --inactiveAccountSnapshot=false --miner.noverify console
