...
var (
	...
	DeleteLeafNodeEpoch = int64(10) // block epoch to delete previous leaf nodes (from active area to temp area) (const)
	...
	InactivateLeafNodeEpoch = int64(10) // block epoch to inactivate inactive leaf nodes (from temp area to inactive trie) (joonha)
	InactiveBoundaryKey = int64(0) // inactive accounts have keys smaller than this key
	InactivateCriterion = int64(10) // inactive accounts were touched more before than this block timestamp (min: 1) (const)
